...
We also considered fitting functions taking both the profile normal and tangent with regard to the model edge into account. Though, the results obtained with the latter are inferior to those obtained with fitting functions taking only the profile normal with regard to the model edge into account. Another alternative consists of sampling complete 2D texture patches around the model landmarks. [Pei10]
